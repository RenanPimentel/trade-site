...
function PageContainer() {
  ...
  const [aboutUsHTML, ] = useState('Nosso sistema de vendas se baseia em simplesmente suprir a necessidade do cliente, na qual o cliente pede o item e o vendemos exclusivamente');
